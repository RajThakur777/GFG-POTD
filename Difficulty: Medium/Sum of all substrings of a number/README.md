<h2><a href="https://www.geeksforgeeks.org/problems/sum-of-all-substrings-of-a-number-1587115621/1?_gl=1*bkro3f*_up*MQ..&gclid=Cj0KCQjwucDBBhDxARIsANqFdr04paitPTJNWsG8-w-C-l4Vxcv-9M-ypqzUTLYmNUlOAhi7Xo037H8aAvckEALw_wcB&gbraid=0AAAAAC9yBkDtVQ26iN_UOOylU9Uj9QP6w">Sum of all substrings of a number</a></h2><h3>Difficulty Level : Difficulty: Medium</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size: 18px;">Given an integer <strong>s</strong> represented as a string, the task is to get the sum of all possible sub-strings of this string.<br></span></p>
